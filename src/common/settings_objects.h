...
namespace PowerToysSettings
{
    ...
    public:
        ...
        void add_bool_toogle(const std::wstring_view& name, UINT description_resource_id, bool value);
        void add_bool_toogle(const std::wstring_view& name, const std::wstring_view& description, bool value);
