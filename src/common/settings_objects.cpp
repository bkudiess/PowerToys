...
namespace PowerToysSettings
{
    ...
    void Settings::add_bool_toogle(const std::wstring_view& name, UINT description_resource_id, bool value)
    {
        add_bool_toogle(name, get_resource(description_resource_id), value);
    }

    void Settings::add_bool_toogle(const std::wstring_view& name, const std::wstring_view& description, bool value)
    {
